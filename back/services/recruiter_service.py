...
from back.schemas.recruiter_schem import RecruiterRead,RecruiterCreate
from back.services.crud_base import CRUDBase
from sqlmodel import Session, select

class CRUDRecruiter(CRUDBase[Recruiter, RecruiterCreate, RecruiterRead]):
...
crud_recruiter = CRUDRecruiter(Recruiter, RecruiterRead)